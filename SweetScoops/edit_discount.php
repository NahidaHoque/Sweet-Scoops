...
if (isset($_POST['product_name']) && !isset($_POST['submit'])) {
    ...
    $query = "SELECT dis_product_id, product_detail, discount_percentage, original_price, discounted_price, product_type, image_path FROM discount_product WHERE product_name = '$product_name'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save'])) {
    ...
    $original_price = mysqli_real_escape_string($conn, $_POST['productPrice']);
    $product_type = mysqli_real_escape_string($conn, $_POST['product_type']);
    $discount_percentage = mysqli_real_escape_string($conn, $_POST['discountPercentage']);
    $discounted_price = mysqli_real_escape_string($conn, $_POST['discountedPrice']);
    $image_path = mysqli_real_escape_string($conn, $_POST['image_path']);

    // Update the discount_product table
    $query = "UPDATE discount_product SET product_detail=?, discount_percentage=?, original_price=?, discounted_price=?, product_type=?, image_path=? WHERE dis_product_id=?";
    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, 'sddsssi', $product_detail, $discount_percentage, $original_price, $discounted_price, $product_type, $image_path, $product_id);

    if (mysqli_stmt_execute($stmt)) {
        header("Location: edit_discount.php?success=1");
        exit();
    } else {
            ...
            <div class="profile-info col-md-9">               
                <div class="panel" >
                    <div class="panel-body">
                        <h1>Edit discount percentage of the product</h1>
                        
                        
                        <form method="post" action="edit_discount.php" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select name="productName" id="productName" class="form-control">
                                ...
                                $query = "SELECT product_name FROM discount_product";
                                $result = mysqli_query($conn, $query);
                            ...
                            $('#productName').change(function(){
                                ...
                                $.ajax({
                                    ...
                                    success: function(response){
                                        ...
                                        $('#discountedPrice').val(response.discounted_price); // Initialize discounted price
                                        $('#discountPercentage').val(response.discount_percentage); // Set the discount percentage
                                    },
