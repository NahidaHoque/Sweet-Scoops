  ...
  <section class="food_section layout_padding">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li data-filter=".burger">Chocolate</li>
        <li data-filter=".pizza">Vanilla</li>
        <li data-filter=".pasta">Coffee</li>
        <li data-filter=".fries">Cone</li>
      </ul>
        ...
        <div class="row grid">
          ...
          <?php
            // Check if the product type is chocolate
                $query = "SELECT * FROM product WHERE product_type='chocolate'";
           ...
           // Check if the product type is chocolate
                    $query = "SELECT * FROM product WHERE product_type='coffee'";
                    $result = mysqli_query($conn, $query);
            ...
            // Check if the product type is chocolate
                $query = "SELECT * FROM product WHERE product_type='vanilla'";
                $result = mysqli_query($conn, $query);
               ...
               // Check if the product type is chocolate
                    $query = "SELECT * FROM product WHERE product_type='cone'";
                    $result = mysqli_query($conn, $query);
