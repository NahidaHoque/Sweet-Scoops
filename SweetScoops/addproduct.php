...
$productnameerr = $productdetailerr = $productpriceerr = $producttypeerr = $productimageerr = "";
$productname = $productdetail = $productprice = $producttype = $productimage = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["productdetail"])) {
        $productdetailerr = "Product Detail is required";
    } else {
        $productdetail = test_input($_POST["productdetail"]);
    }
    ...
    if (!isset($_FILES["productimage"]) || $_FILES["productimage"]["error"] == 4) {
        ...
        if ($check !== false) {
            ...
            $productimageerr = "File is not an image.";
        }
    }
    ...
    $stmt = $conn->prepare("INSERT INTO product (product_name, product_detail, product_price, product_type, image_path) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $productname, $productdetail, $productprice, $producttype, $productimage);
